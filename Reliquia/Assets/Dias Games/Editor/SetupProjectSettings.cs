...
namespace DiasGames.ThirdPersonSystem
{
    public class SetupProjectSettings : EditorWindow
    {
        ...
        void UpdateLayers()
        {
            ...
            AddNewLayer(layersProperty, 25, "Wall Run");
            AddNewLayer(layersProperty, 26, "Wall Climb");

            AddNewTag(tagsProperty, "Enemy");
            AddNewTag(tagsProperty, "Item");
        ...
        public static void SetupInputManager()
        {
            ...
            AddAxis(new InputAxis() { name = "Interact", positiveButton = "f" });
        }
