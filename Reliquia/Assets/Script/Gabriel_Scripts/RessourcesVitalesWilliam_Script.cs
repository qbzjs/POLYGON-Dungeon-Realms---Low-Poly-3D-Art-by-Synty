...
public class RessourcesVitalesWilliam_Script : MonoBehaviour
{
    ...
    void Start()
    {
        if(SceneManager.GetActiveScene().name == "test" || SceneManager.GetActiveScene().name == "Gabriel_Scene_Pouvoirs")
        {
            vieWilliam = maxVie;
            manaWilliam = maxMana;
